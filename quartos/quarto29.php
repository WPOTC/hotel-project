...
$valor = "2989";
$imagens = <<<'HTML'
<img src='../uploads/quartos/cinnanhe-removebg-preview.png' alt='quarto teste' style='width:200px; margin:10px; border-radius:8px;'><br><img src='../uploads/quartos/Gemini_Generated_Image_8wnr5g8wnr5g8wnr.png' alt='quarto teste' style='width:200px; margin:10px; border-radius:8px;'><br><img src='../uploads/quartos/Gemini_Generated_Image_fqj2yofqj2yofqj2.png' alt='quarto teste' style='width:200px; margin:10px; border-radius:8px;'><br>
HTML;
?>
<!DOCTYPE html>
<html lang="pt-br">

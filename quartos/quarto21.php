...
$valor = "158,00";
$imagens = <<<'HTML'
<img src='../uploads/quartos/banheiro-casa-de-campo - Copia.jpg' alt='teste2' style='width:200px; margin:10px; border-radius:8px;'><br><img src='../uploads/quartos/banheiro-casa-de-campo.jpg' alt='teste2' style='width:200px; margin:10px; border-radius:8px;'><br><img src='../uploads/quartos/banheiro-elegante.png' alt='teste2' style='width:200px; margin:10px; border-radius:8px;'><br>
HTML;
?>
<!DOCTYPE html>
<html lang="pt-br">
